...
julian.calc = date => {
	...
	date.j2000 = 2000.0 + (date.julian - J2000) / 365.25;
	date.b1950 = 1950.0 + (date.julian - B1950) / 365.25;
	date.j1900 = 1900.0 + (date.julian - J1900) / 365.25;
